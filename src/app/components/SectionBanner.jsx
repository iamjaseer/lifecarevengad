              ...
              <div className="container">
                <div className="row">
                  ...
                  <h1 data-aos="fade-up" className='heading-secondary mb-sm-4 mb-2'>{props.heading}</h1>
                    <p className='mb-0 mt-sm-4 mt-2' data-aos="fade-up" data-aos-delay={500}>{props.subHeading}</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="container">
                <div className="row">
                  ...
                  <span className='heading-secondary' data-aos="fade-up" dangerouslySetInnerHTML={{ __html: props.heading }} />
                    ...
                    <Link aria-label="View more" data-aos="fade-up" data-aos-delay={500} href={getURL('/'+props.link+'')} className='btn btn-outline p-3 px-4 text-uppercase mt-sm-4 mt-2'>{props.button}</Link>
                  </div>
                </div>
              </div>
            </div>
