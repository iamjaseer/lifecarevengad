          ...
          <div className="row mb-sm-5 mb-2">
            <div className="col-md-4">
              ...
              <ul className="list-inline social mt-4 mb-4 mb-md-0">
                <li className={footerPosts.contactInfoAcf.facebook == null ? 'd-none' : 'list-inline-item'}>
                  <Link rel="nofollow" aria-label="Facebook" href={footerPosts.contactInfoAcf.facebook == null ? '' : footerPosts.contactInfoAcf.facebook} target="_blank">
                ...
                <li className={footerPosts.contactInfoAcf.instagram == null ? 'd-none' : 'list-inline-item'}>
                  <Link rel="nofollow" aria-label="Instagram" href={footerPosts.contactInfoAcf.instagram == null ? '' : footerPosts.contactInfoAcf.instagram} target="_blank">
            ...
            <div className="col-md-8 d-sm-flex align-items-start justify-content-md-end">
              <div className="me-5 pe-xl-5 mt-2 mt-sm-0">
                ...
                <Link rel="nofollow" aria-label="Home" href={getURL("/")} className="mb-2">Home</Link>
                <Link rel="nofollow" aria-label="Doctors" href={getURL("/doctors")} className="mb-2">Doctors</Link>
                <Link rel="nofollow" aria-label="Specialties" href={getURL("/specialties")} className="mb-2">Specialties</Link>
                <Link rel="nofollow" aria-label="Blog" href={getURL("/blogs")} className="mb-2">Blog</Link>
              ...
              <div className='mt-4 mt-sm-0 pt-1 pt-sm-0'>
                ...
                <Link rel="nofollow" aria-label="Phone" href={footerPosts.contactInfoAcf.phone !== null ? '' : footerPosts.contactInfoAcf.phone} className="mb-2">
                  {footerPosts.contactInfoAcf.phone}
                </Link>
                <Link rel="nofollow" aria-label="Email" href={footerPosts.contactInfoAcf.email !== null ? '' : footerPosts.contactInfoAcf.email} className="mb-2">
